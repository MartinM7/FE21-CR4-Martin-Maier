    ...
    for (const val of movies) {
        movie.innerHTML +=`
            <div class="col-12 col-md-6 col-xl-4 mb-4 d-flex align-items-stretch">   
                <div class="card mb-3 bg-dark" style="max-width: auto;">
                    <div class="row g-0 ">
                        <div class="col-md-4">
                ...
                <div class="mt-auto p-2 bd-highlight align-self-end">
                    <button type="button" class="btn-like btn btn-success mb-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up" viewBox="0 0 16 16">
                    ...
                    <p class="showlike card-text text-success display-6 fw-bold ms-2">${val.likes}</p>
                </div>
            </div>
        `
    }
